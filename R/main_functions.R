#--------------------------------------------------------------------------------------------------------------------
# MAR: Calculates mean species richness
#--------------------------------------------------------------------------------------------------------------------
### Log of changes:
# - 03.11.11: Function implemented
# - 15.11.11: Removed bug for the calculation of the number of recorded species for different land use types.
MAR <-
function(dat, surveys, land_use=NA, species_group=NA, start=2001, end=2010, period=5) {
